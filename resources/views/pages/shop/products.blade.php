...
@section('content')
                                                            ...
                                                            <div class="image-box">
                                                                ...
                                                                <div class="action-link">
                                                                    <div class="action-link-left">
                                                                        <a href="#" data-bs-toggle="modal" class="add-to-cart-btn" data-product-id="{{ $item->product->id }}"
                                                                        data-product-price="{{ $item->product->price }}"
                                                                           data-bs-target="#modalAddcart-{{ $item->product->id }}">Add to
                                                                            Cart</a>
                                                                    </div>
                                                        ...
                                                        <div class="product-list-single product-color--golden">
                                                            ...
                                                            <div class="product-list-content">
                                                                ...
                                                                <div class="product-action-icon-link-list">
                                                                    <a href="#"
                                                                       class="btn btn-lg btn-black-default-hover add-to-cart-btn" data-product-id="{{ $item->product->id }}" data-product-price="{{ $item->product->price }}">Add to
                                                                        cart</a>
                                                                    <a href="#" data-bs-toggle="modal"
    ...
    @foreach($items as $item)
        <div class="modal fade" id="modalAddcart-{{ $item->product->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="modal-add-cart-product-img">
                                                <img class="img-fluid"
                                                     src="{{ asset('admin/product/'. $item->product->productImage->first()->image) }}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-7">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="modal-add-cart-product-img">
                                            <img class="img-fluid"
                                                 src="{{ asset('assets/images/product/default/home-1/default-1.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="modal-add-cart-info"><i class="fa fa-check-square"></i>Added to cart
